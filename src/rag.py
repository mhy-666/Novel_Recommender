...
import os
from data_processing import retrieve_recommendations, set_up_pinecone
from LLMs import create_openai_client, get_book_recommendation
...
def get_book_recommendation_rag(client, genre, description):
    ...
    '''
    vector_store = set_up_pinecone(index_name = 'novels', namespace = 'novelvector')
...
if __name__ == '__main__':
    ...
    result = get_book_recommendation_rag(client, 'fantasy', 'space travel and adventure')
    print(result)