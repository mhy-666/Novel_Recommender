...
class TestOpenAIClient(unittest.TestCase):
    ...
    def test_create_openai_client(self, mock_env_get, MockOpenAI):
        ...
        MockOpenAI.assert_called_once_with(
            base_url="https://localhost", api_key="sk-no-key-required"
        )
    ...
    def test_get_book_recommendation(self, MockOpenAI):
        ...
        result = get_book_recommendation(
            client, "science fiction", "space travel and adventure"
        )
        ...
        mock_openai_instance.chat.completions.create.assert_called_once_with(
            ...
            messages=[
                ...
                {
                    "role": "user",
                    "content": "I am looking for a science fiction book. Here are my preferences: space travel and adventure",
                },
            ],
        )
